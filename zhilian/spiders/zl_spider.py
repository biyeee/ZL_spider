...
class ZlSpiderSpider(scrapy.Spider):
    ...
    first_url = 'https://fe-api.zhaopin.com/c/i/sou?start={page}&pageSize=60&cityId=' \
                '489&workExperience=-1&education=-1&companyType=-1&employmentType=-1&' \
                'jobWelfareTag=-1&kw=python&kt=3&lastUrlQuery=%7B%22p%22:2,%22jl%22:%22489%22,%2' \
                '2kw%22:%22python%22,%22kt%22:%223%22%7D'
